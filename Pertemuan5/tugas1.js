...
let biodata = {
    printNama: function(key, value){
      return
    },
    printEmail: function(key, value){
      return
    },
    printPhoneNumber: function(key, value){
      return
    },
    umur: 19,
  ...
  printNama('nama', 'dzaki muhamad mumtaz')
  printEmail('dzaki123@gmail.com')
  printPhoneNumber('081290555874')